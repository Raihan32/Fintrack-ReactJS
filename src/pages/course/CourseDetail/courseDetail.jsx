  ...
  return (
    <Container className="container-course-detail">
      <div className="course-detail">
        <img src={Detail[id - 1].image} alt="foto-1" className="course-cover-detail" />
        <div className="course-card-detail">
          <div className="course-detail-description">
            <p className="course-detail-title">
              <span style={{ fontWeight: 'bold' }}>{Detail[id - 1].heading}</span>
            </p>
            <p className="course-detail-description"></p>
            <button className="course-button-detail" onClick={() => navigate(-1)}>
              BACK
            </button>
            <Link
              to={`/fc/lesson`}
      ...
      <div className="course-detail-course">
        <div className="course-detail-description-course">
          <h4 style={{ color: '#060F76', fontWeight: '700' }}>Auditing : Konsep Dasar Audit Laporan Keuangan</h4>
          <p>{Detail[id - 1].content_description}.</p>
          <h5 style={{ color: '#060F76', fontWeight: '700' }}>{Detail[id - 1].title_description}</h5>
