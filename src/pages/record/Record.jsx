...
class Record extends React.Component {
  ...
  fnHitung() {
    let datalUangIN = this.state.summary.filter(
      (item) => item.category === "IN"
    );
    let nominalUang = datalUangIN.map((item) => item.nominal);
    let jumlahuangIN = nominalUang.reduce((total, num) => total + num);
    let datalUangOUT = this.state.summary.filter(
  ...
  render() {
    return (
      <>
        <Helmet>
          <title>Fintrack | Financial Record</title>
        </Helmet>
          ...
          <div className="row">
            <div className="col-12 text-center">
              ...
              <span className="title-md">
                Sisa uang kamu terisa {this.state.persentasiUang}%
              </span>
            </div>
          </div>
          <div className="row mt-4">
            ...
            <div className="col-6">
              <div className="card-wraper p-4">
                ...
                <div>
                  <span className="title-sm text-pink fw-bold">
            ...
            <div className="col-12 d-flex justify-content-between align-item-center">
              ...
              <div className="wraooer-button d-flex">
                ...
                <ModalCreate
                  action={this.tambahItem}
                  category="OUT"
                  variant="button btn-pink px-3 py-2 me-2"
                  text="pengeluaran"
