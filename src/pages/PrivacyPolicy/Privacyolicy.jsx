...
const Privacyolicy = () => {
  return (
    <div className="container">
      <Helmet>
        <title>Fintrack | Privacy and Policy</title>
      </Helmet>
      <div className="my-5">
        ...
        <p>
          ...
          a "User") of the http://fintrack.com website ("Site"). This privacy
          policy applies to the Site and all products and services offered by
          Money Lover
        </p>
      </div>
      <div>
        <h6 className="pp-subjudul">Personal identification information</h6>
        <p>
      ...
      <div>
        <h6 className="pp-subjudul">Non-personal identification information</h6>
        <p>
          We may collect personal identification information from Users in a
          variety of ways, including, but not limited to, when Users visit our
          site, register on the site, subscribe to the newsletter, respond to a
      ...
      <div>
        <h6 className="pp-subjudul">Web browser cookies</h6>
        <p>
      ...
      <div>
        <h6 className="pp-subjudul">How we protect your information</h6>
        <p>
      ...
      <div>
        <h6 className="pp-subjudul">Sharing your personal information</h6>
        <p>
